...
// ----------------------
//    
//Additional modification by Kuei-Tin Hsu
//Add _rootdir to support extraction to different directory.
        ...
        namespace RestServer
        {
            namespace Common
            {
                ...
                public class ZipEntry
                {
                    ...
                    internal static ZipEntry Create(String filename, String rootdir)
                    {
                        ZipEntry entry = new ZipEntry();
                        entry._rootdir = rootdir;
                    ...
                    private void Extract(string basedir, System.IO.Stream s)
                    {
                        ...
                        using (System.IO.MemoryStream memstream = new System.IO.MemoryStream(_FileData))
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    if (TargetFile != null)
                                        output = new System.IO.FileStream(TargetFile, System.IO.FileMode.Create);
                                    else
                                        output = s;
                    ...
                    private void WriteHeader(System.IO.Stream s, byte[] bytes)
                    {
                        ...
                        {
                            crc = (UInt32)crc32.GetCrc32AndCopy(input, CompressedStream);
                        }
                        ...
                        //to support extraction to different base folder
                        if (_rootdir != null)
                            length -= (short)(_rootdir.Length + 1);
                        ...
                        string sActualName = FileName;
                        //support of extraction to different folder
                        if (_rootdir != null)
                            sActualName = FileName.Substring(_rootdir.Length + 1);
                        char[] c = sActualName.ToCharArray();
                        int j = 0;
                  ...
                  IDisposable
                {
                    ...
                    private System.IO.FileStream WriteStream
                    {
                        get
                        {
                            ...
                            {
                                _writestream = new System.IO.FileStream(_name, System.IO.FileMode.Create);
                            }
                            return _writestream;
                        }
                    }
                    ...
                    {
                        ZipEntry ze = ZipEntry.Create(FileName, _rootdir);
                        _entries.Add(ze);
                    }
